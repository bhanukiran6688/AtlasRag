...
class BM25Index:
    ...
    def __init__(
        ...
        logger.info(
            ...
            self.k1, self.b, self.total_docs
        )
    ...
    def add_document(self, doc_id: str, content: str, metadata: dict | None = None) -> None:
        ...
        logger.debug("Added document %s to BM25 index with %d terms", doc_id, len(terms))
    ...
    def search(self, query: str, k: int = 10) -> List[Tuple[str, float]]:
        ...
        for doc_id, doc in self.documents.items():
            ...
            for term in query_terms:
                ...
                length_norm = 1 - self.b + self.b * (doc.doc_length / self.avg_doc_length)
        ...
        logger.info(
            ...
            query, len(ranked_results), len(query_terms)
        )
    ...
    def _load_index(self) -> None:
        ...
        if self.index_path.exists():
            try:
                ...
                logger.info("Loaded BM25 index from %s with %d documents", self.index_path, self.total_docs)
    ...
    def save_index(self) -> None:
        ...
        try:
            ...
            logger.info("Saved BM25 index to %s with %d documents", self.index_path, self.total_docs)
        except Exception as exc:
