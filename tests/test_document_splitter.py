...
class TestDocumentSplitter:
    ...
    def test_split_documents_splits_long_text(self, monkeypatch):
        ...
        splitter = DocumentSplitter()
        long_text = "This is a long text that should be split into multiple chunks for testing purposes. " * 5
    ...
    def test_split_documents_preserves_metadata(self, monkeypatch):
        ...
        splitter = DocumentSplitter()
        documents = [Document(page_content="Test content", metadata={"source": "test.pdf", "page": 1})]
        result = splitter.split_documents(documents)
