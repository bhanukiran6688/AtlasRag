...
class FakeVectorStore:
    def similarity_search_with_score(
        ...
        return [
            (Document(page_content="The policy starts in 2024.", metadata={"source": "policy.pdf", "page": 1}), 0.1),
            (Document(page_content="Contractors must enroll before June.", metadata={"source": "guide.pdf", "page": 2}), 0.2),
        ]

    def max_marginal_relevance_search(self, **_: Any) -> list[Document]:
        return [Document(page_content="Diverse policy context.", metadata={"source": "policy.pdf", "page": 1})]
